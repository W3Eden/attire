(function ($) {
    $(document).ready(function () {
        ...
        $('body').on('click', '.theme-actions .button.activate', function (e) {
            ...
            modalHtml += '<label><input type="radio" name="switch-reason" value="design"> Design change</label><br>';
            modalHtml += '<label><input type="radio" name="switch-reason" value="performance"> Performance improvement</label><br>';
            ...
            modalHtml += '<label for="switch-description">Description:</label>';
