...
/**
 * Class Name: wp_bootstrap_navwalker_left
 ...
 */
class wp_bootstrap_navwalker_left extends Walker_Nav_Menu
{
    ...
    public function start_lvl(&$output, $depth = 0, $args = array())
    {
        ...
        $output .= "\n$indent<ul role=\"menu\" class=\" dropdown-menu dropleft\">\n";
    }
...
//			$atts['class']  = 'dropdown-item';
            ...
            if ($depth !== 0 && $args->has_children)
                $item_output .= '<span class="dropdown-toggler"><i class="fas fa-angle-left" aria-hidden="true"></i></span>';


            $item_output .= $args->link_before . apply_filters('the_title', $item->title, $item->ID) . $args->link_after;
            if ($depth !== 0) $item_output .= '</a>';
            elseif ($depth === 0) $item_output .= ($args->has_children) ? ' </a><span class="dropdown-toggler"><i class="fas fa-angle-down" aria-hidden="true"></i></span>' : '</a>';
