...
get_header();
global $wp_query;
$post_types = isset( $_REQUEST['post_type'] ) ? $_REQUEST['post_type'] : [ 'post' ];
                    ...
                    <form action="<?php echo esc_url( home_url( '/' ) ) ?>">
                        <div class="form-group">
                            <div class="custom-control custom-switch custom-control-inline">
                                <input <?php checked( 1, in_array( 'post', $post_types ) ) ?> type="checkbox"
                                                                                              id="spost-srp"
                                                                                              name="post_type[]"
                                                                                              value="post"
                            ...
                            <div class="custom-control custom-switch custom-control-inline">
                                <input <?php checked( 1, in_array( 'page', $post_types ) ) ?> type="checkbox"
                                                                                              id="spage-srp"
                                                                                              name="post_type[]"
                                                                                              value="page"
                                                                                              class="custom-control-input">
					...
					while ( have_posts() ): the_post();
                        ...
                        <div class="search-item">
                            ...
                            <div class="card mb-3 <?php echo $post->post_type ?>-card"
                                 data-posttype="<?php echo get_post_type_object( $post->post_type )->labels->singular_name; ?>">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="mr-3">
                                            <a class="search-image-link"
                                               href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'thumbnail', [ 'class' => 'attire-search-image' ] ); ?></a>
                                        </div>
